...
export default function PlaylistEditor({ playlist, onClose, onSave }: PlaylistEditorProps) {
  ...
  // NEW: remove a single video from this playlist (local, applied on Save)
          ...
          {items.map((v, idx) => (
            ...
            >
              ...
              <button
                ...
                className="ml-2 px-2 py-1 inline-flex items-center gap-1 rounded bg-red-600 hover:bg-red-700 text-white text-xs shrink-0"
